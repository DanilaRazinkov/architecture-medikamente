...
|----------|------------------------------------|--------------------------------------------------------|---------------------------------------------|--------------------------------------------------|------------------|
| **P0-1** | Открытое хранение медицинских карт | Сканы карт в JPG/PDF доступны всем пользователям сети  | Утрата доверия, штрафы до 300К ₽            | Компрометация всех медицинских данных            | 2 недели         |
